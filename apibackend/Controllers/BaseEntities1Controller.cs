...
namespace apibackend.Controllers
{
    ...
    [ApiController]
    public class BaseEntities1Controller : ControllerBase
    {
        private readonly UniversityDb _context;

        public BaseEntities1Controller(UniversityDb context)
        {
            _context = context;
        }

        // GET: api/BaseEntities1
        [HttpGet]
